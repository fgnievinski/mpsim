function lineHandles = dline(linePropertiesList, label, textPosition, textPropertiesList, axesHandle, isLineColorSynchronizedWithText)
...
% Acknowledgement:  It was based on hline() written by Hoi Wong.
    ...
    lineHandles = plot(axesHandle, xLimits, yLimits, linePropertiesList{:});
