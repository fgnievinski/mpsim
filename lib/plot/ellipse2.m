...
%  y=radm*cos(the)*si+co*radn*sin(the)+ypos;
  h(k)=fill(radm*cos(the)*co-si*radn*sin(the)+xpos,radm*cos(the)*si+co*radn*sin(the)+ypos,C);
  set(h(k),'FaceColor',C(rem(k-1,size(C,1))+1,:));
  set(h(k),'EdgeColor',C(rem(k-1,size(C,1))+1,:));
