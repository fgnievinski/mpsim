function export_reflection_to_googleearth (filepath, gps_pos_geod, ...
ffz_pos_local, refl_pos_local, circ_pos_local, circ_elev)
    ...
    doit = @(x, c) my_ge_plot(x(:,2), x(:,1), ...
        'lineWidth',5.0, 'lineColor',ge_color(c,1));
