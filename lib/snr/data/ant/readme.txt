...
The profile data has two formats: basic and extended (respectively, with file extensions .dat and .datx).
...
For the basic format, one principal plane cut is allowed.
...
The extended profile format allows for multiple plane cuts.
It is made of three columns: boresight angle, azimuthal angle, and pseudo-gain.
