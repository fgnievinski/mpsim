function [peak, snr_detrended_fit, snr_detrended, J] = snr_bias_fit_sinusoid (...
snr_detrended, elev, ...
degree, refine_peak, ...
height_domain, wavelength, J, plotit)
    ...
    if ~isnan(degree)
        % Further detrending is often necessary because the direct power bias 
